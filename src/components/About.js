          ...
          <VStack>
            <Box maxW={'2xl'}>
              <Text textAlign={'center'} mt={{ base: 2, sm: 6, md: 6 }}>
                ...
                Aperiam iure sit voluptatibus adipisci illum, deleniti quibusdam
                saepe laudantium corrupti neque, blanditiis veniam reiciendis
                tempore fuga? Porro repudiandae natus maiores nulla eligendi sed
                consectetur assumenda magni, impedit totam sunt praesentium
                animi? Lorem ipsum dolor sit amet. Lorem, ipsum.
              </Text>
            </Box>
            <Box maxW={'2xl'} mt={10}>
